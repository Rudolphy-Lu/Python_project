...
app = Flask(__name__)
app.config["SECRET_KEY"] = "4ea54ney5n48qly7neby" # 設置一個金鑰用於加密 session 資料
app.config["SESSION_TYPE"] = "filesystem"  # 將 Session 存儲在伺服器端的檔案系統中
app.config["MAIL_SERVER"] = "smtp.mail.yahoo.com"
app.config["MAIL_PORT"] = 587 # Yahoo Mail 使用的port
app.config["MAIL_USERNAME"] = "rudolphy1987@yahoo.com"
app.config["MAIL_PASSWORD"] = "hncpjwwanwsarhbv" # 此參數為獨有的，不能隨意分享予他人
